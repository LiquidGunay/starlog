...
- The unified proof runner is now `./scripts/cross_surface_proof_bundle.sh`, which bundles hosted PWA, installed phone-app, and desktop-helper evidence into one artifact tree while preserving the older Velvet-named entrypoint as a compatibility wrapper.
