...
- Calendar event updates now support optional `base_revision` optimistic-concurrency checks using `calendar_events.revision`; stale updates return structured `409 revision_conflict` responses with persisted conflict records.
