...
- 2026-03-14: Notes API now supports `base_revision` optimistic concurrency checks and emits structured `409 revision_conflict` responses with persisted conflict IDs for explicit `/v1/conflicts` resolution flows.
