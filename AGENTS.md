...
- 2026-03-14: Desktop-helper macOS permission logic can be improved from Linux, but real validation of `pbpaste`/`screencapture`/`osascript` behavior still requires a native macOS host with System Settings privacy prompts.
