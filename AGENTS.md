...
- 2026-03-14: iOS share-extension intake is now enabled in app config and mobile draft dedupe handling was hardened, but this Linux/WSL host cannot run `expo run:ios`; full iOS share-sheet validation still requires a macOS/Xcode pass.
