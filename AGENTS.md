...
- 2026-03-14: Added a Sync Center `Offline Warmup` flow that preloads snapshot-backed route data; current warmup seeds artifact detail snapshots from the first returned artifact and records per-step failures instead of failing the whole run.
