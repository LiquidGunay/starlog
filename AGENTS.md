...
- 2026-03-14: Tasks API now accepts optional `base_revision` on updates and rejects stale writes with structured `409 revision_conflict` payloads that reference persisted `/v1/conflicts` records.
