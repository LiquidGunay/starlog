    ...
    with tempfile.TemporaryDirectory(prefix="starlog-release-handoff-smoke-") as tmp:
        ...
        with tarfile.open(tarball_path, "r:gz") as archive:
            ...
            expected_docs = {
                ...
                "docs/architecture/assistant-protocol.md",
                "docs/architecture/interview-prep-loop.md",
                "docs/architecture/deployment.md",
                "docs/architecture/diagrams/system-context.mmd",
                "docs/architecture/diagrams/assistant-runtime-sequence.mmd",
                "docs/architecture/diagrams/interview-prep-loop.mmd",
                "docs/architecture/diagrams/data-provenance.mmd",
                "docs/architecture/diagrams/deployment-topology.mmd",
